...
**YOU ARE IN: `pymoney/polecats/chrome/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/pymoney/` (rig root) or other directories
...
**Your mail address:** `pymoney/polecats/chrome`
**Your rig:** pymoney
**Your Witness:** `pymoney/witness`
...
| Ask Witness for help | `gt mail send pymoney/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`pymoney/witness`) when:
...
```bash
gt mail send pymoney/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
